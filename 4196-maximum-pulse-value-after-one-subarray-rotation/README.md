<h2><a href="https://leetcode.com/problems/maximum-pulse-value-after-one-subarray-rotation">Maximum Pulse Value After One Subarray Rotation</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code> of length <code>n</code>.</p>
